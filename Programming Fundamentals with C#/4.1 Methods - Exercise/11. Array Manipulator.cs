...
class Program
{
        ...
        while ((commands = Console.ReadLine()) != "end")
        {
            ...
            switch (commandArray[0])
            {
                case "exchange":
                    ...
                    {
                        ExchangeIndex0(inputArray, commandArray);
                        break;
                    }

                    SplitArrayAfterGivenIndex_ExchangeThePlaces(inputArray, commandArray);
                    break;
    ...
    private static void ExchangeIndex0(int[] inputArray, string[] commandArray)
    {
    ...
    private static void SplitArrayAfterGivenIndex_ExchangeThePlaces(int[] inputArray, string[] commandArray)
    {
        int[] manipulationArray = new int[inputArray.Length];
